...
namespace eCommerce.Services
{
    public class ProductsService
    {
        ...
        public bool UpdateProductDiscountDetails(int ProductID, List<ProductDiscountDetails> newDiscountDetails)
        {
            var context = DataContextHelper.GetNewContext();

            var oldDiscountDetails = context.ProductDiscountDetails.Where(d => d.ProductRecordID == ProductID);

            context.ProductDiscountDetails.RemoveRange(oldDiscountDetails);

            context.ProductDiscountDetails.AddRange(newDiscountDetails);
