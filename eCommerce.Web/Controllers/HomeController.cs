...
namespace eCommerce.Web.Controllers
{
    public class HomeController : PublicBaseController
    {
        ...
        public ActionResult SearchWebCategories(string category, string q, decimal? from, decimal? to, string sortby, int? pageNo, int? recordSize)
        {
            recordSize = recordSize ?? (int)RecordSizeEnums.Size10;
            ...
            return PartialView("_SearchWebCategories", model);
        }
